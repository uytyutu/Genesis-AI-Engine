...
## 1.3 Genesis Laws — постоянные правила

Краткая форма: `Genesis_Laws.md`

| # | Название | Суть |
|---|----------|------|
| — | **Dogfood First** | Всё новое сначала помогает Genesis Company, потом клиентам |
| **№1** | **Plan → Approve → Act** | Анализ → план → подтверждение CEO → выполнение → отчёт. Никаких автоматических критичных действий |
| — | **Company OS** | Не «ещё один AI». Система, через которую реально работает компания |
| — | **Experience > Knowledge** | Знать факты мало. Важно знать, **что реально сработало** (уровень Experience в Brain) |
| **№2** | **Одно окно** | Новая функция должна уменьшать необходимость открывать другие программы. GitHub, Railway, браузер — сигналы пробела |
| **№3** | **Время CEO** | Функция нужна, если ускоряет работу, снижает ошибки или улучшает понимание ситуации |

**Три слоя Genesis:**

1. **Продукт** — сайт, Desktop, услуги  
2. **Компания** — процессы, знания, стандарты, релизы  
3. **Философия** — Laws и принципы развития  
