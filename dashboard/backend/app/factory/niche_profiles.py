...
_PROFILES: dict[str, NicheProfile] = {
    ...
    "cleaning": NicheProfile(
        "cleaning",
        "Reinigung",
        NicheStyle("#0e7490", "#155e75", "#67e8f9", "linear-gradient(135deg,#083344,#0e7490)"),
    ),
    ...
    "accounting": NicheProfile(
        "accounting",
        "Steuerberatung",
        NicheStyle("#0f766e", "#115e59", "#99f6e4", "linear-gradient(135deg,#134e4a,#0f766e)"),
    ),
    ...
    "fitness": NicheProfile(
        "fitness",
        "Fitness",
        NicheStyle("#ea580c", "#9a3412", "#fdba74", "linear-gradient(135deg,#1c1917,#ea580c)"),
    ),
    "realestate": NicheProfile(
        "realestate",
        "Immobilien",
        NicheStyle("#1d4ed8", "#1e3a8a", "#93c5fd", "linear-gradient(135deg,#0f172a,#1d4ed8)"),
    ),
