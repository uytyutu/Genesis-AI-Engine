...
_UI: dict[str, dict[str, str]] = {
    "de": {
        ...
        # R3.3: marketing claims belong in Hero pills / Benefits — not as section titles.
        "trust_section_title": "Vertrauen & Qualität",
        "trust_credentials_title": "Unsere Zusagen",
