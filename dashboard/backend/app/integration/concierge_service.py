...
class ConciergeService:
    ...
    def ask(self, question: str, context: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        if self._match(lower, "привет", "здравств", "hello", "hi", "hallo", "добрый"):
            return self._reply(
                f"Здравствуйте! Я — {ASSISTANT_NAME}, ваш цифровой руководитель в {BRAND_NAME}.\n\n"
        ...
        if self._match(
            ...
            return self._reply(
                ...
                f"**Сейчас доступно:**\n"
                f"• Работа с {ASSISTANT_NAME} в цифровой компании\n"
                f"• Заказ **лендинга** — пакеты от **{self._min_price} €** (350 / 650 / 1200 €)\n\n"
                f"**{STUDIO_NAME}** (подписка и рабочая среда) **пока в разработке** — купить онлайн нельзя.\n\n"
                f"Я — {ASSISTANT_NAME}, цифровой руководитель ваших проектов в {BRAND_NAME}. Расскажите, какой сайт или бизнес вам нужен.",
            )
    ...
    def _studio_pitch(self) -> dict[str, Any]:
        return self._reply(
            ...
            f"**Сейчас доступно:**\n"
            f"• Бесплатная работа с Vector в цифровой компании\n"
            f"• Заказ **лендинга** под ключ — пакеты от **{self._min_price} €** "
    ...
    def _pricing_reply(self) -> dict[str, Any]:
        ...
        lines.extend(
            [
                ...
                "Начните с поручения Vector или оформите заказ после согласования."
                "",
