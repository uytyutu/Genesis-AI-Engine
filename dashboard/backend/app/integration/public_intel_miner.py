...
_DEFAULT_PATTERN_CONFIG: dict[str, Any] = {
    "hunter_mode": "service_first",
    "zero_cost": True,
    "priority": "outreach",
    "pattern_rules": [
        {
            "id": "cms_wordpress_old",
            "label": "Veraltetes WordPress",
            "regex": r"wp-content|wordpress\s*[0-9]\.[0-4]\.",
            "search_in": ["site_analysis"],
            "data_product_value_eur": 75.0,
            "lane": "bounty_report",
            "min_confidence": 0.65,
        },
        {
            "id": "cms_joomla_drupal",
            "label": "Legacy CMS",
            "regex": r"joomla|drupal\s*[0-7]\.|powered by joomla",
            "search_in": ["site_analysis"],
            "data_product_value_eur": 70.0,
            "lane": "bounty_report",
            "min_confidence": 0.65,
        },
        {
            "id": "copyright_stale",
            "label": "Veraltetes Copyright",
            "regex": r"copyright\s*(©|\(c\))?\s*(199[0-9]|200[0-9]|201[0-9]|202[0-3])",
            "search_in": ["site_analysis", "fit_reason"],
            "data_product_value_eur": 50.0,
            "lane": "seo_revival",
            "min_confidence": 0.6,
        },
        {
        ...
        },
        {
            ...
            "regex": r"Kontaktformular|E-Mail-Feld",
            "search_in": ["site_analysis"],
            "data_product_value_eur": 120.0,
            "lane": "outreach_lead",
            "min_confidence": 0.7,
        },
        {
            "id": "dead_content",
            "label": "Wenig Inhalt / Platzhalter",
            "regex": r"wenig Inhalt|Platzhalter|veraltet",
            "search_in": ["site_analysis", "notes"],
            "data_product_value_eur": 100.0,
            "lane": "seo_revival",
            "min_confidence": 0.65,
        },
        {
            "id": "public_business_email",
            "label": "Öffentliche Geschäfts-E-Mail",
            "regex": r"[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}",
            "search_in": ["site_analysis", "fit_reason"],
            "data_product_value_eur": 3.0,
            "lane": "dataset_row",
            "min_confidence": 0.55,
        },
        {
            "id": "eth_contract_public",
            "label": "Public ETH contract reference",
            "regex": r"0x[a-fA-F0-9]{40}",
            "search_in": ["site_analysis", "fit_reason", "notes"],
            "data_product_value_eur": 25.0,
            "lane": "digital_dust",
            "min_confidence": 0.7,
        },
        {
            "id": "defi_orphan_pool",
            "label": "Orphan / abandoned liquidity signal",
            "regex": r"orphan\s+(?:pool|token)|abandoned\s+liquidity|stuck\s+liquidity|paused\s+pool",
            "search_in": ["site_analysis", "fit_reason", "notes"],
            "data_product_value_eur": 40.0,
            "lane": "digital_dust",
            "min_confidence": 0.65,
        },
        {
            "id": "public_claim_function",
            "label": "Public withdraw/claim signal",
            "regex": r"withdraw\s*\(|claim\s*\(|recover\s*\(|unclaimed\s+rewards",
            "search_in": ["site_analysis", "fit_reason", "notes"],
            "data_product_value_eur": 35.0,
            "lane": "digital_dust",
            "min_confidence": 0.65,
        },
    ],
    "garbage_filter": {
        ...
        "max_hits_per_asset": 12,
        "ttl_days": 90,
    },
    "execution_policy": {
        "auto_buy": False,
        "auto_outreach_draft": True,
        "require_ceo_approval": True,
        "hunter_mode": "service_first",
        "zero_cost": True,
        "priority": "outreach",
        "note": "Hunter-Gatherer: Outreach/SEO/Bounty — keine Asset-Käufe.",
    },
}
