...
_POOLS: dict[str, list[str]] = {
    "greeting": [
        ...
        "Рад на связи. О чём думаете сегодня?",
        "Приветствую Вас. Расскажите, что у Вас на уме.",
        "Хорошо, что Вы здесь. С чего начнём?",
    ],
    "small_talk": [
        "Спасибо, что спросили — у меня всё в порядке, готов помочь Вам.\n\nА у Вас как дела?",
        "На связи. Давайте поговорим — о чём хотите?",
