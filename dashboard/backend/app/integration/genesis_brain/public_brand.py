...
PUBLIC_WELCOME = (
    ...
    "Расскажу о продуктах и услугах, ценах и защите данных (мы никому не передаём ваши данные). "
    "Сам файлы и сайты не выдаю — только ссылки на форму заказа или поддержку."
)
