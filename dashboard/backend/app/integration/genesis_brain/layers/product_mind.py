...
def compose(
    ...
    if rec.recommend == "service":
        path_block = (
            ...
            "**Genesis Studio** — если планируете создавать много проектов сами. "
        ...
        path_block = (
            ...
            "тогда **Genesis Studio** действительно окупится: инструменты, лимит проектов, "
        ...
        path_block = (
            ...
            "Или Вы можете **собрать самостоятельно в Genesis Studio**, "
