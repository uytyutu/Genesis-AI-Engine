...
_NICHE_STACKS: dict[str, tuple[str, list[str], str]] = {
    ...
    "salon": (
        ...
        "от 399 € (Business) или 699 € (Premium)",
    ),
    "shop": (
        "интернет-магазин",
        [
...
def compose(
    ...
    if rec.recommend == "service":
        ...
        path_block = (
            "**Когда дойдёте до оформления:** лендинг под ключ на /order (199 / 399 / 699 €).\n\n"
...
- Цены Mission 1: 199 / 399 / 699 € на /order — только из фактов каталога, не выдумывать.
