...
_PACKAGES = {
    ...
    "office_searchable": {
        "id": "office_searchable",
        "name": "Virtus Office · Durchsuchbares PDF",
        "price_eur": 9.90,
        "product_kind": "office",
        "tagline": "Searchable PDF",
        "included_summary": "PDF mit durchsuchbarer Textschicht",
        "deliverables": ["Searchable PDF"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_redaction": {
        "id": "office_redaction",
        "name": "Virtus Office · Schwärzung / Redaction",
        "price_eur": 9.90,
        "product_kind": "office",
        "tagline": "PII redaction",
        "included_summary": "PDF-Kopie ohne personenbezogene Daten im Text",
        "deliverables": ["Redacted PDF"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_fillable": {
        "id": "office_fillable",
        "name": "Virtus Office · Ausfüllbares PDF",
        "price_eur": 19.90,
        "product_kind": "office",
        "tagline": "Fillable AcroForm PDF",
        "included_summary": "PDF mit echten ausfüllbaren Formularfeldern",
        "deliverables": ["Fillable PDF (AcroForm)"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_pdf_a": {
        "id": "office_pdf_a",
        "name": "Virtus Office · PDF/A-2b",
        "price_eur": 9.90,
        "product_kind": "office",
        "tagline": "Archiv-PDF (structural PDF/A-2b)",
        "included_summary": "PDF/A-2b strukturell (OutputIntent + XMP) — nicht veraPDF-Zertifikat",
        "deliverables": ["PDF/A-2b"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_archive": {
        "id": "office_archive",
        "name": "Virtus Office · Dokumenten-Archiv",
        "price_eur": 29.90,
        "product_kind": "office",
        "tagline": "Batch archive ZIP + index",
        "included_summary": "Mehrere Dokumente → Ordner, Umbenennung, ZIP + index.xlsx",
        "deliverables": ["ZIP Archiv", "index.xlsx", "manifest.json"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_cv_bewerbung": {
    ...
    "office_large_pack": {
        ...
        "name": "Virtus Office · CV & Bewerbung",
        "price_eur": 24.90,
        "product_kind": "office",
        "tagline": "CV & Bewerbung Paket",
        "included_summary": "Lebenslauf + Anschreiben + Bewerbungspaket (PDF/DOCX/ZIP)",
        "deliverables": ["CV", "Cover letter", "Application ZIP"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_pdf_pro": {
        "id": "office_pdf_pro",
        "name": "Virtus Office · PDF PRO",
        "price_eur": 29.90,
        "product_kind": "office",
        "tagline": "PDF PRO one-time package",
        "included_summary": "Searchable · Redaction · Fillable · PDF/A · Archive · Quality",
        "deliverables": ["PDF PRO ZIP"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_translation_pack": {
        "id": "office_translation_pack",
        "name": "Virtus Office · Translation Pack",
        "price_eur": 19.90,
        "product_kind": "office",
        "tagline": "Translation Pack one-time",
        "included_summary": "Translated PDF/DOCX package with QA",
        "deliverables": ["Translation ZIP"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_complex_from": {
    ...
    "office_sales_kit_basic": {
        "id": "office_sales_kit_basic",
        "name": "Virtus Office · Sales Kit Basic",
        "price_eur": 99.0,
        "product_kind": "office",
        "tagline": "Sales Kit Basic",
        "included_summary": "Company Profile PDF/DOCX",
        "deliverables": ["Sales Kit ZIP"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_sales_kit_business": {
        "id": "office_sales_kit_business",
        "name": "Virtus Office · Sales Kit Business",
        "price_eur": 199.0,
        "product_kind": "office",
        "tagline": "Sales Kit Business",
        "included_summary": "Profile · Angebot · Preislist · Email",
        "deliverables": ["Sales Kit ZIP"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
    "office_sales_kit_professional": {
        "id": "office_sales_kit_professional",
        "name": "Virtus Office · Sales Kit Professional",
        "price_eur": 299.0,
        "product_kind": "office",
        "tagline": "Sales Kit Professional",
        "included_summary": "Full Sales Kit + QA",
        "deliverables": ["Sales Kit ZIP"],
        "eta_days": "minutes",
        "purchase_type": "one_time",
    },
