...
_NICHES_BY_LANG: dict[str, list[str]] = {
    "de": ["Kfz-Werkstatt", "Zahnarztpraxis", "Dachdecker"],
    "en-us": ["auto repair", "dentist", "plumber"],
    "en": ["auto repair", "dentist", "plumber"],
    "uk": ["автосервіс", "стоматологія", "сантехнік"],
    "ru": ["автосервис", "стоматология", "сантехник"],
}
