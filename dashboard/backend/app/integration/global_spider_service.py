...
_DEFAULT_GLOBAL_CONFIG: dict[str, Any] = {
    ...
    "max_batch": 1000,
    "note": "Добавьте seed_targets (публичные URL) или включите GOOGLE_PLACES_API_KEY.",
}
...
class GlobalSpiderService:
    ...
    def load_config(self) -> dict[str, Any]:
        ...
        if not path.is_file():
            ...
            path.write_text(
                json.dumps(_DEFAULT_GLOBAL_CONFIG, ensure_ascii=False, indent=2),
                encoding="utf-8",
            )
            return dict(_DEFAULT_GLOBAL_CONFIG)
        try:
    ...
    def discover_candidate_urls(
        ...
        *,
        ...
        seen: set[str] = set()
        urls: list[str] = []
        stats = {"seeds": 0, "places": 0, "regions_scanned": 0, "tech_filter": tech_pattern_ids or []}
