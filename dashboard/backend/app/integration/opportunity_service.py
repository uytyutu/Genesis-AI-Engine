...
class OpportunityService:
    ...
    def _normalize_row(self, row: dict) -> dict:
        ...
        return {
            ...
            "recommended_currency": str(row.get("recommended_currency") or "").strip(),
            "recommended_symbol": str(row.get("recommended_symbol") or "").strip(),
            "recommended_price_label": str(row.get("recommended_price_label") or "").strip(),
