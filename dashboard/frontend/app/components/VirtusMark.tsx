  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="vc-breathe" x1="72" y1="48" x2="440" y2="472" gradientUnits="userSpaceOnUse">
...
export function VirtusMark({
  className = "h-10 w-10",
  animate = true,
}: {
  className?: string;
  /** When false, render a static SVG (public /site — avoids Framer hydrate flicker). */
  animate?: boolean;
}) {
