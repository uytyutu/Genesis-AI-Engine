    ...
    <div className={`mt-4 ${className}`}>
        ...
        <button
          ...
          className={`rounded-lg px-2.5 py-1 text-[11px] font-medium transition ${
            mode === "site"
              ...
              : "bg-white/5 text-genesis-muted hover:bg-white/10"
          }`}
        >
          {t("order.previewLiveSite")}
        </button>
        <button
          type="button"
      ...
      <div
        ...
        onTouchEnd={(e) => {
          ...
          touchX.current = null;
          paused.current = false;
          if (start == null || mode !== "gallery") return;
