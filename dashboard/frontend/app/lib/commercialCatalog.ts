...
export const PRODUCT_SHOWCASE_GROUPS: {
  ...
  },
  {
    id: "bots",
    title: "AI Bots",
    blurb: "Separate from websites. Order a bot without buying a site.",
  },
  {
    id: "website_services",
...
export const COMMERCIAL_CATALOG: CommercialRow[] = [
  ...
  },
  {
    ...
    cta_label: "Order",
    includes: "Business bot for Telegram · multi-channel wizard · setup questionnaire after purchase",
  },
  {
    id: "website_ai_chat",
    category: "product",
    ...
    cta_href: "/order/bot?package=bot_business",
    cta_label: "Order",
    includes: "Chat widget for your site · same bot packages as Telegram",
  },
  {
    id: "whatsapp_ai_bot",
    category: "product",
