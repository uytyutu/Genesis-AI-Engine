...
const FAQ = [
  {
    ...
    a: "Ориентир 5–14 дней после подтверждения заказа. Точный срок виден на странице статуса заказа.",
  },
  {
  ...
  },
  {
    ...
    a: "После заказа вы видите цену. Если онлайн-оплата подключена — через Stripe; иначе мы свяжемся и выставим счёт.",
  },
  {
    q: "Могу ли я следить за прогрессом?",
    a: "Да. После оформления заказа вы получаете страницу статуса и письмо со ссылкой.",
  },
  {
